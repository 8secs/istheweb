...
class ModalContext extends ControllerBehavior {
    ...
    public function onCreateForm(){
		...
		return $this->controller->makePartial('$/netsti/connections/partials/_create.htm');
	}
	...
	public function onCreateModal(){
		...
		// return $this->controller->makeRedirect('create', $this->controller->model);
	...
	public function onUpdateForm(){
		...
		$this->controller->vars['recordId'] = post('record_id');
		return $this->controller->makePartial('$/netsti/connections/partials/_update.htm');
	}
	...
	public function onPreviewForm(){
		...
		$this->controller->vars['recordId'] = post('record_id');
		return $this->controller->makePartial('$/netsti/connections/partials/_preview.htm');
	}
