...
class ProjectCategory extends Model
{
     ...
     */
    public $table = 'istheweb_corporate_project_categories';
    ...
    public $hasOne = [];
    public $hasMany = [
        'children' => ['Istheweb\Corporate\Models\ProjectCategory', 'key' => 'parent_id'],
    ];
    public $belongsTo = [
        'parent' => ['Istheweb\Corporate\Models\ProjectCategory', 'key' => 'parent_id'],
    ];
    public $belongsToMany = [
        'projects' => ['Istheweb\Corporate\Models\Project',
    ...
    public static function getMenuTypeInfo($type)
    {
        ...
        if ($type == 'all-project-categories') {
            $result = [
                'dynamicItems' => true
            ];
        }
        ...
        if ($result) {
            ...
            foreach ($pages as $page) {
                 ...
                 */
                $properties = $page->getComponentProperties('Projects');
                if (!isset($properties['projectCategoryFilter']) || !preg_match('/{{\s*:/', $properties['projectCategoryFilter'])) {
                    continue;
                }
    ...
    public static function resolveMenuItem($item, $url, $theme)
    {
        ...
        elseif ($item->type == 'all-project-categories') {
            $result = [
                'items' => []
            ];
    ...
    protected static function getCategoryPageUrl($pageCode, $category, $theme)
    {
        ...
        $properties = $page->getComponentProperties('Projects');
        if (!isset($properties['projectCategoryFilter'])) {
            return;
        }
         ...
         * eg: {{ :someRouteParam }}
         */
        if (!preg_match('/^\{\{([^\}]+)\}\}$/', $properties['projectCategoryFilter'], $matches)) {
            return;
        }
